...
def get_client():
    ...
    Usiamo lo schema https:// (HTTP puro) invece di libsql:// (WebSocket):
    su Streamlit Cloud l'handshake WebSocket in uscita spesso fallisce
    (WSServerHandshakeError), mentre l'HTTP funziona sempre in modo affidabile.
    """
